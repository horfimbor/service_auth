...
ARG BINARY_NAME_DEFAULT=service_auth
ARG MOD_AUTH_SECRET_DEFAULT="someconfig-secret"
...
ARG BINARY_NAME_DEFAULT
ENV BINARY_NAME=$BINARY_NAME_DEFAULT
ARG MOD_AUTH_SECRET_DEFAULT
ENV MOD_AUTH_SECRET=$MOD_AUTH_SECRET_DEFAULT
